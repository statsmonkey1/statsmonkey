...
private_posting_key = '5JaeTnmuVmscvTswwaZvBCScwbBhpDbuEoZeQzXroqea6nZJp16'
private_active_key = '5KTkYxGjSmgz2y4nDkFqcMpk2CXCuTcRyjvgdQJVuifTmUDKCWo'
...
tags = [currency,'cryptocurrencies', 'money', 'stats', 'trading']
...
to_email = "Matthew.brophy30@gmail.com"
...
try:
    ...
    ax[0].plot(df3['price_usd'], alpha = 0.7, lw = 2.0, label = currency + " price (USD)")
    ax[1].plot(df3['aroon_up'], alpha = 0.7, lw = 2.0, label = 'Aroon-Up', color = 'g')
...
try:
    s.commit.post(title, body, "bitgeek", tags = tags)
except:
